                      ...
                      <div className="rounded-lg border bg-background p-2 shadow-sm">
                        <div className="grid grid-cols-2 gap-2">
                          <div className="flex flex-col items-center">
                            ...
                            <span className={`font-bold ${(payload[0].value)as number > 30 ? "text-orange-600" : "text-blue-300" }`}>
                              {payload[0].value}°
                            </span>
                          </div>
                          <div className="flex flex-col items-center">
                            ...
                            <span className={`font-bold ${(payload[1].value)as number > 30 ? "text-orange-600" : "text-blue-300" }`}>
                              {payload[1].value}°
                            </span>
                          </div>
                        </div>
